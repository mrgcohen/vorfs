...
<h3>
<div id = "totalscore"><?php echo 'Total Score: '. $team_total;?></div>
<div id = "totalrank"><?php echo ' Overall rank: '. $place. ' of '. $num_teams;?></div>
<br>
</h3>
...
<?  if($username == $this->session->userdata('username')) 
	{ ?>
    <p></p><a href="<?php site_url()?>../../players" class="button">Add Player</a>
    <a href="<?php site_url()?>../../settings" class="button" id="wooo">Change Team Name</a>
<?  } 
    if(isset($team_roster[0]))
	echo '
	<a href="#data" class="button" id="inline">Compare players</a>'
?>
